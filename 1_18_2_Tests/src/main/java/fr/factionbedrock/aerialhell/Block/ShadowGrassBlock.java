...
public class ShadowGrassBlock extends GrassBlock
{
	...
	public void onPlantGrow(BlockState state, LevelAccessor world, BlockPos pos, BlockPos source)
	{
		...
		{
			world.setBlock(pos, AerialHellBlocks.SHADOW_GRASS_BLOCK.get().defaultBlockState(), 2);
		}
	}*/
	...
	public void performBonemeal(ServerLevel worldIn, Random rand, BlockPos pos, BlockState state)
	{
	      ...
	      BlockState blockstate = AerialHellBlocks.SHADOW_GRASS.get().defaultBlockState();

...
public class BedrockChestTileEntityRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<BedrockChestTileEntity>
{
		...
		public BedrockChestTileEntityRenderer(TileEntityRendererDispatcher blockEntityRenderDispatcher) {
	...
	@Override
	public void render(BedrockChestTileEntity entity, float tickDelta, MatrixStack matrices, IRenderTypeBuffer vertexConsumers, int light, int overlay)
	{
				...
				if (item.get() instanceof BlockItem)
				{
					...
					if (block instanceof ChestBlock)
					{
						...
						LAYERS.put(block, new RenderType[]{
							RenderType.getEntityCutout(new ResourceLocation(BedrockChest.MODID, "textures/entity/chest/" + name + ".png")),
							RenderType.getEntityCutout(new ResourceLocation(BedrockChest.MODID, "textures/entity/chest/" + name + "_left.png")),
							RenderType.getEntityCutout(new ResourceLocation(BedrockChest.MODID, "textures/entity/chest/" + name + "_right.png"))
						});
					}
				}
		});

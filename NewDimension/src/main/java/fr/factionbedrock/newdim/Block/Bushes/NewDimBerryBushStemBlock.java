...
public class NewDimBerryBushStemBlock extends NewDimBushBlock implements IGrowable
{
	protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0, 0.0, 2.0, 14.0, 13.0, 14.0);

	public NewDimBerryBushStemBlock(AbstractBlock.Properties properties) {super(properties);}
	...
	@Override
	public boolean canUseBonemeal(World worldIn, Random rand, BlockPos pos, BlockState state) {return rand.nextFloat() < 0.45F;}

	@Override
	public void grow(ServerWorld worldIn, Random rand, BlockPos pos, BlockState state)
	{
		worldIn.setBlockState(pos, Registration.NEWDIM_BERRY_BUSH.get().getDefaultState());
	}
}
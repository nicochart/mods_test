...
@OnlyIn(Dist.CLIENT)
public class NewDimEntityModel<T extends NewDimEntity> extends BipedModel<T>
{
	private final ModelRenderer newdimentity;
	...
	public NewDimEntityModel()
	{
		super(0F, -14F, 64, 64);
		textureWidth = 64;
		textureHeight = 64;

		newdimentity = new ModelRenderer(this);
		newdimentity.setRotationPoint(0.0F, 24.0F, 0.0F);
		

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -34.0F, 0.0F);
		newdimentity.addChild(head);
		...
		newdimentity.addChild(rightArm);
		...
		newdimentity.addChild(rightLeg);
	...
	{
		newdimentity.render(matrixStack, buffer, packedLight, packedOverlay);
	}

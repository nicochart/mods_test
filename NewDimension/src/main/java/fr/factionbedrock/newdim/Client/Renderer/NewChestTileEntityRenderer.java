...
public class NewChestTileEntityRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<NewDimChestTileEntity>
{
		...
		public NewChestTileEntityRenderer(TileEntityRendererDispatcher blockEntityRenderDispatcher) {
	...
	@Override
	public void render(NewDimChestTileEntity entity, float tickDelta, MatrixStack matrices, IRenderTypeBuffer vertexConsumers, int light, int overlay)
	{
		...
		if (entity.hasChest()) block = entity.getChest();
	...
	static
	{
		...
		RegisterItems.ITEMS.getEntries().forEach
		((item) ->	{
				if (item.get() instanceof BlockItem)
				{
					...
					if (block instanceof ChestBlock)
					{
						...
						LAYERS.put(block, new RenderType[]{
							RenderType.getEntityCutout(new ResourceLocation(NewDimension.MODID, "textures/entity/chest/" + name + ".png")),
							RenderType.getEntityCutout(new ResourceLocation(NewDimension.MODID, "textures/entity/chest/" + name + "_left.png")),
							RenderType.getEntityCutout(new ResourceLocation(NewDimension.MODID, "textures/entity/chest/" + name + "_right.png"))
						});
					}
				}
		});

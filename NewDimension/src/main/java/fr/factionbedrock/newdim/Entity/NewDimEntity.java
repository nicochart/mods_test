...
public class NewDimEntity extends AbstractNewDimEntity {

    public NewDimEntity(EntityType<? extends MonsterEntity> type, World world)
    {
        super(type, world);
    }
    ...
    /*Do not forget to register those attributes by calling the method !! See Register/RegisterEntityAttributes for more details*/

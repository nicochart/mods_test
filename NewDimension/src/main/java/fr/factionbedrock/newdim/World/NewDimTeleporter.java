...
public class NewDimTeleporter implements ITeleporter {
    ...
    public Optional<TeleportationRepositioner.Result> makePortal(BlockPos pos, Direction.Axis axis) {
        ...
        BlockState aetherPortal = Registration.NEWDIM_PORTAL.get().getDefaultState().with(NewDimPortalBlock.AXIS, axis);
    ...
    public PortalInfo getPortalInfo(Entity entity, ServerWorld destWorld, Function<ServerWorld, PortalInfo> defaultPortalInfo) {
        boolean isAether = destWorld.getDimensionKey() == ModDimensions.NEW_DIMENSION;
        if (entity.world.getDimensionKey() != ModDimensions.NEW_DIMENSION && !isAether) {
            return null;
        }
        else {

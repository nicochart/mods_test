...
public class NewNoiseChunkGenerator extends ChunkGenerator {
   public static final Codec<NewNoiseChunkGenerator> field_236079_d_ = RecordCodecBuilder.create((p_236091_0_) -> {
   ...
   protected final long field_236084_w_;
   protected final Supplier<DimensionSettings> field_236080_h_;
   private final int field_236085_x_;

   public NewNoiseChunkGenerator(BiomeProvider p_i241975_1_, long p_i241975_2_, Supplier<DimensionSettings> p_i241975_4_) {
      this(p_i241975_1_, p_i241975_1_, p_i241975_2_, p_i241975_4_);
   }

   private NewNoiseChunkGenerator(BiomeProvider p_i241976_1_, BiomeProvider p_i241976_2_, long p_i241976_3_, Supplier<DimensionSettings> p_i241976_5_) {
